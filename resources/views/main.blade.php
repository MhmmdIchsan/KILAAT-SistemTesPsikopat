...
<body class="bg-black font-Poppins text-white">
    ...
    <main>
        <div
            class="container w-5/5 mx-auto m-6 p-8 h-auto block border rounded-xl shadow-lg bg-gray-900 border-gray-700">

            <form action="{{ route('saiko.store') }}" method="POST" enctype="multipart/form-data"
                class=" rounded-lg p-8 text-justify">
                @csrf
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q1" id="{{ $jawaban1->id }}" value="{{ $jawaban1->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q2" id="{{ $jawaban2->id }}" value="{{ $jawaban2->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q3" id="{{ $jawaban3->id }}" value="{{ $jawaban1->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q4" id="{{ $jawaban4->id }}" value="{{ $jawaban4->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q5" id="{{ $jawaban5->id }}" value="{{ $jawaban5->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q6" id="{{ $jawaban6->id }}" value="{{ $jawaban6->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q7" id="{{ $jawaban7->id }}" value="{{ $jawaban7->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q8" id="{{ $jawaban8->id }}" value="{{ $jawaban8->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q9" id="{{ $jawaban9->id }}" value="{{ $jawaban9->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q10" id="{{ $jawaban10->id }}" value="{{ $jawaban10->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q11" id="{{ $jawaban11->id }}" value="{{ $jawaban11->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q12" id="{{ $jawaban12->id }}" value="{{ $jawaban12->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q13" id="{{ $jawaban13->id }}" value="{{ $jawaban13->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q14" id="{{ $jawaban14->id }}" value="{{ $jawaban14->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q15" id="{{ $jawaban15->id }}" value="{{ $jawaban15->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q16" id="{{ $jawaban16->id }}" value="{{ $jawaban16->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q17" id="{{ $jawaban17->id }}" value="{{ $jawaban17->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q18" id="{{ $jawaban18->id }}" value="{{ $jawaban18->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q19" id="{{ $jawaban19->id }}" value="{{ $jawaban19->point }}"
                            class="mr-2">
                ...
                <fieldset class="mb-14">
                    ...
                    <div class="mb-2">
                        <input type="radio" name="q20" id="{{ $jawaban20->id }}" value="{{ $jawaban20->point }}"
                            class="mr-2">
                ...
                <div class="flex justify-center">
                    <button type="submit"
                        class="text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Kirim</button>
                </div>
            </form>
        </div>
    ...
    <footer class="bg-gray-900 w-full absolute border-t-2 border-black  block">
        <div class="w-full max-w-screen-xl mx-auto p-2 flex justify-center">
            <span class="block text-sm text-white dark:text-gray-400 mt-5">© 2023 <span
                    class="font-semibold">SAIKO</span><a href="https://flowbite.com/" class="hover:underline"></a>. All
                Rights Reserved.</span>
        </div>
        <div class="flex justify-center">
            <span class="text-sm text-white dark:text-gray-400 mb-4"> Designed by <a
                    href="https://bootstrapmade.com/">Kelompok 2</a></span>
        </div>
    </footer>
